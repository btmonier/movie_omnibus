...
class ConfirmDialog(
    ...
    /**
     * Show a confirmation dialog with Material Design styling.
        ...
        container.append {
            div {
                ...
                onClickFunction = { event ->
                    if (event.target == document.getElementById("confirm-dialog-overlay")) {
                        close()
                        onCancel?.invoke()
                    }
                }
                ...
                div {
                    ...
                    div {
                        ...
                        button {
                            ...
                            """.trimIndent()
                            attributes["onmouseover"] = "this.style.backgroundColor='rgba(26, 115, 232, 0.08)'"
